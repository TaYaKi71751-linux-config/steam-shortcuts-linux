...
let apps = [
	...
	{AppName: '[Proton] World of Warcraft', exe: `"${process.env.HOME}/Games/battlenet/drive_c/Program Files (x86)/World of Warcraft/_retail_/Wow.exe"`, StartDir: `"${process.env.HOME}/Games/battlenet/drive_c/Program Files (x86)/World of Warcraft/"`, compat:'proton_9', LaunchOptions:`STEAM_COMPAT_DATA_PATH="${process.env.HOME}/Games/battlenet" %command%`,background: `${process.env.PWD}/image/background/wow.png`, wideCapsule: `${process.env.PWD}/image/widecapsule/wow.png`, capsule: `${process.env.PWD}/image/capsule/wow.png`, logo: `${process.env.PWD}/image/logo/wow.png`, icon: `${process.env.PWD}/image/icon/wow.png` },
