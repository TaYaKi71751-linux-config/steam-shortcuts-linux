...
try{config.game.path.global = \`\${process.env.HOME}/${__GAME_NAME__}/Genshin Impact game\`;}catch(e){console.error(e);}
try{config.game.path.china = \`\${process.env.HOME}/${__GAME_NAME__}/Genshin Impact game\`;}catch(e){console.error(e);}
